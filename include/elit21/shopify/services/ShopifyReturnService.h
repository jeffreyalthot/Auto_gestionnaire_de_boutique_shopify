...
class ShopifyReturnService final : public platform::BusinessComponent {
public:
    ShopifyReturnService();
    explicit ShopifyReturnService(ShopifyClient& client);
    ...
    Result<Json> orderReturns(int first = 100, const std::string& after = {},
