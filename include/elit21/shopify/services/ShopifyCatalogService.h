...
class ShopifyCatalogService final : public platform::BusinessComponent {
public:
    ShopifyCatalogService();
    explicit ShopifyCatalogService(ShopifyClient& client);
    ...
    Result<Json> catalogPage(int first = 100, const std::string& after = {},
