...
class ShopifyLocationService final : public platform::BusinessComponent {
public:
    ShopifyLocationService();
    explicit ShopifyLocationService(ShopifyClient& client);
    void bind(ShopifyClient& client) noexcept { client_ = &client; }
    [[nodiscard]] bool bound() const noexcept { return client_ != nullptr; }
    Result<std::string> primaryLocation();
