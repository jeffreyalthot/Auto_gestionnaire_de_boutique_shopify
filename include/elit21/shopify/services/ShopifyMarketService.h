...
class ShopifyMarketService final : public platform::BusinessComponent {
public:
    ShopifyMarketService();
    explicit ShopifyMarketService(ShopifyClient& client);
    ...
    Result<Json> marketsPage(int first = 100, const std::string& after = {},
