...
class ShopifyCollectionService final : public platform::BusinessComponent {
public:
    ShopifyCollectionService();
    explicit ShopifyCollectionService(ShopifyClient& client);
    ...
    Result<Json> collectionsPage(int first = 100, const std::string& after = {},
