...
class ShopifyCustomerService final : public platform::BusinessComponent {
public:
    ShopifyCustomerService();
    explicit ShopifyCustomerService(ShopifyClient& client);
    ...
    Result<Json> customersPage(int first = 100, const std::string& after = {},
