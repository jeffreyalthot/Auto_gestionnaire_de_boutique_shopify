...
class ShopifyDraftOrderService final : public platform::BusinessComponent {
public:
    ShopifyDraftOrderService();
    explicit ShopifyDraftOrderService(ShopifyClient& client);
    ...
    Result<Json> draftOrdersPage(int first = 100, const std::string& after = {},
