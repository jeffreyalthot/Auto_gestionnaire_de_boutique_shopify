...
class ShopifyDiscountService final : public platform::BusinessComponent {
public:
    ShopifyDiscountService();
    explicit ShopifyDiscountService(ShopifyClient& client);
    ...
    Result<Json> discountsPage(int first = 100, const std::string& after = {},
