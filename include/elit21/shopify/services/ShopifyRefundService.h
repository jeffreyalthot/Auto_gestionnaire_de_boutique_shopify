...
class ShopifyRefundService final : public platform::BusinessComponent {
public:
    ShopifyRefundService();
    explicit ShopifyRefundService(ShopifyClient& client);
    ...
    Result<Json> orderRefunds(int first = 100, const std::string& after = {},
