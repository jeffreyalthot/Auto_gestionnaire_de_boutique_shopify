...
class ShopifyMediaService final : public platform::BusinessComponent {
public:
    ShopifyMediaService();
    explicit ShopifyMediaService(ShopifyClient& client);
    ...
    Result<Json> productMedia(int first = 100, const std::string& after = {},
