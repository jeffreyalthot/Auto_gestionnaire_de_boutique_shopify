...
class ShopifyMetafieldService final : public platform::BusinessComponent {
public:
    ShopifyMetafieldService();
    explicit ShopifyMetafieldService(ShopifyClient& client);
    ...
    Result<Json> ownerMetafields(int first = 100, const std::string& after = {},
